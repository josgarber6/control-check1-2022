...
This is a fork of https://github.com/spring-projects/spring-petclinic to be used for the Control Check of the DP1 course. 

You can find the control check [here](control-check.pdf)

The main changes that have been performed with respect to the spring-petclinic provided in the course are:
- Trimming several parts of the application to keep the example low
- Reorganizing some parts of the code according to best practices introduced in the course
- Adding a skeleton in package _feedings_ of the classes that need to be developed in the control check
